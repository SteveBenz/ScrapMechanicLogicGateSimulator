...
a shame to just delete it, so here it is.  What follows is the readme I wrote for that version of the app
when the readme seemed like the best place to put a the help and so forth.
